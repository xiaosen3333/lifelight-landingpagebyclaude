        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">{t('download.stats.downloads')}</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-rose-pink mb-2">4.8</div>
              <p className="text-gray-600">{t('download.stats.rating')}</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-mint-blue mb-2">50+</div>
              <p className="text-gray-600">{t('download.stats.countries')}</p>
            </div>
          </div>
        </div>
      </div>
